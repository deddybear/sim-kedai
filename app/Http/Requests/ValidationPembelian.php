...
class ValidationPembelian extends FormRequest
{
    /**
    ...
    {
        return [
            'description.required'  => 'Silahkan isi Deskripsi, Tidak boleh kosong',
            'description.string'    => 'Silahkan isi Deskripsi dengan benar',
            'description.between'   => 'Deskripsi harus antara 3 huruf sampai 255',
